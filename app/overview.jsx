      ...
      {open && (
        <div className="ovx-panel">
          <div className="aii-ov-note">
            ...
            <p>Unlike other publications in this dashboard, the AI Index tracks indicator values rather than standardised country rankings. Explore the Artificial Intelligence Index tab for full indicator detail and country comparisons.</p>
          </div>
