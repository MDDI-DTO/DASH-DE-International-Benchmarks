...
function OvCard({ model, open, onToggle, onNavigate }) {
  ...
  return (
    <div className={'ovx-card' + (open ? ' open' : '')} ref={cardRef}>
      ...
      {/* R8 Change 1 — static nav hint, visible in the collapsed state, sitting
         just above the expand trigger. */}
      <p className="card-nav-hint">Click the respective card titles or pillars to explore its dashboard →</p>
...
function OvPlaceholderCard() {
  return (
    <div className="ovx-card ovx-card-placeholder">
      <div className="ovx-accent" style={{ background: '#9CA3AF' }} />
      <div className="ovx-title">Artificial Intelligence Index (AII)</div>
      <div className="ovx-src"><span>Stanford University</span></div>
