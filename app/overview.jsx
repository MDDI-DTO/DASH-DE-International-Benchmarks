      ...
      options: {
        ...
        scales: {
          y: {
            ...
            ticks: { stepSize: _inc, font: { size: 12 }, color: '#94a1b0', precision: 0 }, grid: { color: 'rgba(16,40,64,0.06)' },
          },
...
function OverviewView() {
  ...
  return (
    <div className="site ov-fluid">
      {/* Fix 3 — TODO: replace with finalised copy */}
      <p className="ov-intro">DASH-DE tracks Singapore’s performance across leading international benchmark publications in the Digital Economy and AI domains, consolidating rankings, trends, and pillar-level detail in one place.</p>
