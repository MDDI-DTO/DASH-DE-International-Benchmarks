...
/* Change 1 (Round 4) — finalised full-width Overview intro copy. Static editorial
   text (not Supabase data). Domain names are bolded inline via <strong>. */
...
const CARD_DESCRIPTIONS = {
  'NRI': 'This publication covers how well countries leverage network technologies (ICT) for economic and social development across four pillars (Technology, People, Governance, and Impact), and consists of 53 indicators.',
  ...
  'IMD WDC': 'This publication covers the capacity and readiness of economies to adopt and explore digital technologies across three pillars (Knowledge, Technology, and Future Readiness), and consists of 61 criteria (40 statistical indicators and 21 survey questions).',
  'Global AI Index': "This publication covers countries' AI investment, innovation, and implementation capacity across three pillars (Implementation, Innovation, Investment) and consists of 122 indicators.",
  'Government AI Readiness Index': "This publication covers governments' capacity to harness AI for public benefit across six pillars (Policy Capacity, Governance, AI Infrastructure, Public Sector Adoption, Development and Diffusion, and Resilience), and consists of 69 indicators across 14 dimensions.",
};
...
function OvPillarTable({ model }) {
  ...
  return (
    <table className="ovx-ptable">
      <thead>
        <tr>
          <th className="ovx-pt-ind">Indicator</th>
              ...
              <td className="ovx-pt-ind">
                ...
                <div className="ovx-ind-cell">
                  ...
                  <span className="ovx-ind-text">
                    <span className="ovx-pr-label">{r.label}</span>
