        ...
        <div className="panel">
          <div className="panel-head panel-head-row">
            <div className="ph-titles">
              ...
              <div className="panel-sub">{drill ? 'Hover over a bar for score details' : `Click on a country to explore its indicators · Showing ${matrix ? matrix.rows.length : 0} countries`}</div>
            </div>
          </div>
          {drill
            ? <div className="panel-body">
