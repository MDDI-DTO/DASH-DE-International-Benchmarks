...
function App({ dataSource }) {
  ...
  function switchDomain(d) {
    ...
    if (d === 'AI') { setAiLevel1('gai'); setGariPillar(null); setGari2025InitialPillar(null); setAiPillarId(((PILLARS['AI'] || [])[0] || {}).id); }
  }
  ...
  function navigateFromOverview(pub, pillarLabel) {
    if (pub === 'IMD WCY') {
      ...
      // No individual GAI pillar deep-dive pages exist — always land on the GAI tab.
      ...
      {domain === 'AI' && (
        <div className="level1-tabs">
          <button className={'l1' + (aiLevel1 === 'gai' ? ' active' : '')} style={{ '--tab-accent': PUB_COLOR['Global AI Index'] }}
            onClick={() => { setAiLevel1('gai'); setGariPillar(null); setGari2025InitialPillar(null); }}>Global AI Index</button>
