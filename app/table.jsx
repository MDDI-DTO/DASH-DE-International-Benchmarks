  ...
  return (
    <div className="panel">
      <div className="panel-head">
        <div className="panel-title">Comparison of sub-indicators across countries · <span style={{ color: countryColor, fontWeight: 600 }}>{country}</span></div>
        <div className="panel-sub">Click on a third-tier indicator to explore its country comparison · Click ⓘ for definition</div>
      </div>
